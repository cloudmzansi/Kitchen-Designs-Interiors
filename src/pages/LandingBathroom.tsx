...
import heroBg from '../assets/bathrooms/bathroom-hero.jpg';
import heroBgAvif from '../assets/bathrooms/bathroom-hero.avif';
...
const LandingBathroom = () => {
  // Set landing source for tracking
  useEffect(() => {
    sessionStorage.setItem('landing_source', 'bathroom');
  }, []);

  // EDIT ZONE: Page-specific meta tags
  usePageMeta({
    title: "Bathroom Renovations Cape Town | Luxury Bathrooms & Premium Finishes",
    description: "Looking for professional bathroom renovations in Cape Town? We design, manage, and build bespoke bathrooms with luxury finishes and end-to-end project management. Get a free quote.",
    canonical: "https://kdinteriors.co.za/landing/bathroom"
  });

  const { formIds, isFormSubmitting, formErrors, handleSubmit } = useLandingForm('bathroom-landing');
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    >
                      ...
                      <option value="bathroom" selected>Bathroom Renovations</option>
...
export default LandingBathroom;
