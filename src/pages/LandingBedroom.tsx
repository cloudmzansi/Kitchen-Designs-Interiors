...
import heroBg from '../assets/bedrooms/bedroom-hero.jpg';
import heroBgAvif from '../assets/bedrooms/bedroom-hero.avif';
...
const LandingBedroom = () => {
  // Set landing source for tracking
  useEffect(() => {
    sessionStorage.setItem('landing_source', 'bedroom');
  }, []);

  // EDIT ZONE: Page-specific meta tags
  usePageMeta({
    title: "Bedroom Renovations Cape Town | Custom Bedrooms & Master Suites",
    description: "Looking for professional bedroom renovations in Cape Town? We design, manage, and build bespoke bedrooms with custom wardrobes and premium finishes. Get a free quote.",
    canonical: "https://kdinteriors.co.za/landing/bedroom"
  });

  const { formIds, isFormSubmitting, formErrors, handleSubmit } = useLandingForm('bedroom-landing');
        ...
        sliders={[
          {
            ...
            alt: 'Bedroom transformation before and after',
          },
          {
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    >
                      ...
                      <option value="bedroom" selected>Bedroom Renovations</option>
